        ...
        <div className="container my-3">
            ...
            <form className="my-3">
                <div className="mb-3">
                    ...
                    <div className="container my-2 form-text">
                        {(note.title.length < 5) && 'Title should be min of 5 characters'}
                    </div>
                ...
                <div className="mb-3">
                    ...
                    <div className="container my-2 form-text">
                        {(note.description.length < 5) && 'Description should be min of 5 characters'}
                    </div>
                </div>
                <div className="mb-3">
